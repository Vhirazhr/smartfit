...
<div class="container" style="max-width: 760px; margin: 36px auto; padding: 0 16px;">
    <h2 style="margin-bottom: 12px;">Create Fashion Category</h2>
    <p style="margin-top:0; color:#666;">Add a category for dynamic gallery grouping.</p>
    ...
    <form method="POST" action="{{ route('admin.fashion-categories.store') }}" style="background:#fff; border:1px solid #eee; border-radius:10px; padding:16px;">
        @csrf

        <div style="margin-bottom:10px;">
            <label for="name">Name *</label><br>
            <input id="name" type="text" name="name" value="{{ old('name') }}" required maxlength="100" style="width:100%; padding:8px;">
        </div>

        <div style="margin-bottom:10px;">
            <label for="slug">Slug *</label><br>
            <input id="slug" type="text" name="slug" value="{{ old('slug') }}" required maxlength="120" style="width:100%; padding:8px;">
        </div>
        ...
        <div style="display:flex; gap:8px;">
            <button type="submit" style="padding:8px 12px;">Save Category</button>
